...
Input trade:
```json
{"ticker": "AAPL", "quantity": 100, "price": 190, "currency": "USD", "counterparty": "MS", "trade_dt": "2024-06-05", "settle_dt": "2024-06-07"}
```
Possible output:
```json
{
  "status": "WARNING",
  "issues": [
    {"type": "price_tolerance", "severity": "WARNING", "field": "price", "message": "Price deviates 3.00% from market"}
  ],
